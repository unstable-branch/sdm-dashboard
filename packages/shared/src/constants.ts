...
export const DEFAULT_CONFIG = {
  ...
  tuningMethod: "none" as const,
  enmevalAlgorithm: "maxnet" as const,
  enmevalPartitions: "block" as const,
  enmevalSelectionMetric: "auc.val.avg" as const,
  enmevalTuneArgs: { fc: ["L", "LQ", "LQH"], rm: [0.5, 1, 2, 3, 4] } as Record<string, unknown>,
  enmevalNullIterations: 100,
