ui_sidebar_controls <- function() {
  ...
  div(class = "control-section",
    ...
    conditionalPanel("input.data_source == 'upload' && output.is_dwca === true",
  ...
  div(class = "control-section",
    ...
    conditionalPanel("input.climate_source == 'chelsa'",
      checkboxGroupInput("chelsa_extras", "CHELSA bioclim-plus variables",
                         choices = c("GDD5" = "gdd5", "GDD10" = "gdd10", "Growing season length" = "gsl",
  ...
  tags$details(class = "control-section",
    ...
    div(class = "details-body",
      ...
      conditionalPanel("input.use_uv == true",
        checkboxGroupInput("uv_vars", "UV-B variables",
                           choices = c("UVB1 Annual Mean" = "UVB1", "UVB2 Seasonality" = "UVB2",
        ...
        checkboxGroupInput("uv_months", "Monthly UV-B",
                           choices = c("January" = "January", "February" = "February", "March" = "March",
      ...
      conditionalPanel("input.use_vegetation == true",
      ...
      conditionalPanel("input.use_lulc == true",
      ...
      conditionalPanel("input.use_hfp == true",
      ...
      conditionalPanel("input.use_bioclim_season == true",
      ...
      conditionalPanel("input.use_drought == true",
